...
{ 
	...
	// Operations
		 ...
		 */
		const_iterator FindFile(const Beroux::IO::Renaming::CPath& fnFileName) const
		{
			const_iterator iter;
		...
		void AddFile(Beroux::IO::Renaming::CPath fnFileName, bool bChecked=true)
		{
	...
	private:
		...
		public:
			...
			// Trivial Iterator:
			const Beroux::IO::Renaming::CPath& operator* () const { return m_iter->fnBefore; }
			const Beroux::IO::Renaming::CPath* operator->() const { return & operator*(); }
		...
		public:
			...
			// Output Iterator
			Beroux::IO::Renaming::CPath& operator* () const { return m_iter->fnAfter; }
			Beroux::IO::Renaming::CPath* operator->() const { return & operator*(); }
